---
layout: post
title: About Low-Code AI Pipeline Development Platform
author: Hyacinth Ali
tags: post template
subtitle: The Low-Code AI Pipeline Development Project is a community-driven initiative dedicated to exploring the current practices of AI pipeline development across various research domains. Our mission is to create a low-code platform that empowers domain experts—regardless of their programming expertise—to efficiently design and implement AI pipelines.
category: project1
---
...
> War does not decide who is _right_, only who is **left**.
